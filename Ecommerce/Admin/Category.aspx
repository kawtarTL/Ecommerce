                                ...
                                <table class="table data-table-export table-hover nowrap">
                                    <thead>
                                        <tr>
                                            ...
                                            <th>IsActive</th>
                                            <th>CreatedDate</th>
                                            <th class="database-nosort">Action</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                            ...
                            <ItemTemplate>
                                <tr>
                                    <td class="table-plus"><%# Eval("CategoryName") %></td>
                                     <td>
                                         <img width="40" src="<%# Ecommerce.Utils.getImageUrl(Eval("CategoryImageUrl")) %>" alt=""/>
                                     </td>
                                    <td>
                                        <asp:Label ID="lblIsActive" runat="server"
                                            Text='<%#(bool) Eval("IsActive") == true ?"Active":"In-Active" %>'
                                            CssClass='<%#(bool) Eval("IsActive") == true ?"bage badege-success":"badge badge-danger" %>'>
                                    ...
                                    <td>
                                        <asp:LinkButton ID="lblEdit" Text="Edit" runat="server" CssClass="badge badge-primary"
                                            CommandeArgument='<% Eval("CategoryId") %>' CommandName="edit" CausesValidation="false">

                                            <i class="fas fa-edit"></i>

                                        </asp:LinkButton>
                                         <asp:LinkButton ID="lbDelete" Text="Delete" runat="server" CssClass="badge badge-danger"
                                             CommandeArgument='<% Eval("CategoryId") %>' CommandName="delete" CausesValidation="false">
